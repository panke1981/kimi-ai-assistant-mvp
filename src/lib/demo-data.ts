...
export const DEMO_FILES = [
  {
    id: 1,
    periodId: DEMO_PERIOD.id,
    companyId: DEMO_COMPANY.id,
    name: "demo-sales-2026-04.xlsx",
    originalName: "2026年4月销售数据.xlsx",
    mimeType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
    fileType: "sales" as const,
    size: 248360,
    status: "processed" as const,
    aiRecognizedFields: [],
    confirmedFields: null,
    storagePath: null,
    createdAt: new Date("2026-04-30T10:00:00"),
  },
  {
    id: 2,
    periodId: DEMO_PERIOD.id,
    companyId: DEMO_COMPANY.id,
    name: "demo-cost-2026-04.csv",
    originalName: "2026年4月成本费用.csv",
    mimeType: "text/csv",
    fileType: "financial" as const,
    size: 86420,
    status: "processed" as const,
    aiRecognizedFields: [],
    confirmedFields: null,
